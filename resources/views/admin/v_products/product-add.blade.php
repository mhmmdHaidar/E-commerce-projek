        ...
        >
            ...
            <div class="wg-box">
                <fieldset class="name">
                    <div class="body-title mb-10">
                        Nama Produk <span class="tf-color-1">*</span>
                    </div>
                    <input
                        class="mb-10"
                        type="text"
                ...
                <div class="gap22 cols">
                    <fieldset class="category">
                        <div class="body-title mb-10">
                            Categori <span class="tf-color-1">*</span>
                        </div>
                        <div class="select">
                ...
                <fieldset class="shortdescription">
                    <div class="body-title mb-10">
                        Deskripsi singkat <span class="tf-color-1">*</span>
                    </div>
                    <textarea
                        class="mb-10 ht-150"
                ...
                <fieldset class="description">
                    <div class="body-title mb-10">
                        Deskripsi <span class="tf-color-1">*</span>
                    </div>
                    <textarea
                        class="mb-10"
                        name="description"
            ...
            <div class="wg-box">
                <fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        <div class="item" id="imgpreview" style="display: none">
                            <img
                                src="../../../localhost_8000/images/upload/upload-1.png"
                                class="effect8"
                                alt=""
                            />
                        </div>
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        <div class="body-title mb-10">
                            Harga <span class="tf-color-1">*</span>
                        </div>
                        <input
                            class="mb-10"
                            type="text"
                    ...
                    <fieldset class="name">
                        <div class="body-title mb-10">
                            Harga Jual <span class="tf-color-1">*</span>
                        </div>
                        <input
                            class="mb-10"
                            type="text"
                ...
                <div class="cols gap22">
                    <fieldset class="name">
                        <div class="body-title mb-10">
                            Kode Barang <span class="tf-color-1">*</span>
                        </div>
                        <input
                            class="mb-10"
                            type="text"
