                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>Rp. {{ number_format($dashboardDatas[0]->TotalAmount) }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>Rp. {{ number_format($dashboardDatas[0]->TotalOrderedAmount) }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>Rp. {{ number_format($dashboardDatas[0]->TotalDeliveredAmount) }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>Rp. {{ number_format($dashboardDatas[0]->TotalCanceledAmount) }}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="wg-box">
                    ...
                    <div class="flex flex-wrap gap40">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap10">
                                <h4>Rp. {{ number_format($TotalOrderedAmount) }}</h4>
                            </div>
                        </div>
                        <div>
                            <div class="mb-2">
