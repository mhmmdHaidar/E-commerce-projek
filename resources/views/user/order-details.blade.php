            ...
            <div class="col-lg-10">
                <div class="wg-box">
                    ...
                    >
                        <div class="row">
                            <div class="col-6">
                                ...
                                <a
                                    href="{{ route('user.order.detail', ['order_id' => $order->id]) }}"
                                    class="btn btn-dark"
                                    >BAYAR SEKARANG</a
                                >
                                @endif
                    ...
                    <div class="table-responsive">
                        ...
                        @endif
                        <table
                            class="table table-bordered table-striped table-transaction"
                        >
                            <tr>
                                <th>No Pesanan</th>
                                <td>{{ $order->id }}</td>
                ...
                <div class="wg-box mt-5">
                    ...
                    <div class="my-account__address-item col-md-6">
                        <div class="my-account__address-item__detail">
                            <h4>Nama : {{ $order->name }}</h4>
                            <h4>Alamat : {{ $order->address }}</h4>
                            <h4>Kecamatan : {{ $order->state }}</h4>

                            <h4>Kota / Kabupaten :{{ $order->city }}</h4>
                            <h4>Provinsi : {{ $order->landmark }}</h4>
                            <h4>Kode Pos :{{ $order->zih4 }}</h4>
                            <br />
                            <h4>No telepon : {{ $order->h4hone }}</h4>
                            <h4>Pesan : {{ $order->locality }}</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="wg-box mt-5 text-right">
                    <form
                        action="{{ route('user.order.cencel') }}"
                        method="POST"
                    >
                        @csrf @method('PUT')
                        <input
