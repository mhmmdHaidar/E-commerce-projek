                    ...
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100">
                            ...
                            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
                                ...
                                <h2 class="h1 fw-normal mb-0 animate animate_fade animate_btt animate_delay-5 font-mode">
                                    {{ $slide->title }}
                                </h2>
                                <h2 class="h1 fw-bold animate animate_fade animate_btt animate_delay-5 font-mode">
                                    {{ $slide->subtitle }}
                                </h2>
                                <a href="{{ $slide->link }}"
                                                ...
                                                <div class="product-card__price d-flex">
                                                    <span class="money price text-secondary">
                                                        @if ($sproduct->sale_price)
                                                            <s>Rp. {{ number_format($sproduct->regular_price) }}</s>
                                                            Rp. {{ number_format($sproduct->sale_price) }}
                                                        @else
                                                            Rp. {{ number_format($sproduct->regular_price) }}
                                                        @endif
                                                    </span>
                                                </div>
                                            </div>
                    ...
                    @foreach ($fproduct as $f)
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details', ['product_slug' => $f->slug]) }}">
                                        <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $f->image }}"
                                            width="330" height="400" alt="{{ $f->name }}" class="pc__img" />
                                    </a>
                                </div>
                                ...
                                <div class="pc__info position-relative">
                                    <h6 class="pc__title">
                                        <a
                                            href="{{ route('shop.product.details', ['product_slug' => $f->slug]) }}">{{ $f->name }}</a>
                                    </h6>
                                    <div class="product-card__price d-flex align-items-center">
                                        <span class="money price text-secondary">
                                            @if ($f->sale_price)
                                                <s>Rp. {{ number_format($f->regular_price) }}</s>
                                                Rp. {{ number_format($f->sale_price) }}
                                            @else
                                                Rp. {{ number_format($f->regular_price) }}
                                            @endif
                                        </span>
                                    </div>
